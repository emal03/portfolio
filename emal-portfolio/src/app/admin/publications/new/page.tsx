...
export default function AddPublicationPage() {
    ...
    return (
        <div className="p-8 max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl font-bold mb-8">Add New Publication</h1>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g., Expert Fusion Network for Automated Blastocyst Morphology..."
                        />
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex gap-2 mb-4">
                        <input
                            ...
                            placeholder="Add author name (e.g., Emal Kamawal)"
                    ...
                    <p className="text-xs text-gray-500 mt-3">Tip: Add authors in the order they appear on the paper. Your name will be highlighted.</p>
                </div>
